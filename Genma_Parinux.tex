...
\justifying{
Différents thèmes vont être abordés et nous reviendrons ensuite sur chacun d'eux via les questions/réponses à la fin.
\\~\\ Rassurez-vous, le monologue ne sera pas très long ;-)
}
\end{frame}
...
\begin{frame}
\begin{center}
\Huge{Via des inititaives comme A.I.\up{2} par exemple}
\end{center}
\end{frame}
%----------------------------------------------------------------------------------------
